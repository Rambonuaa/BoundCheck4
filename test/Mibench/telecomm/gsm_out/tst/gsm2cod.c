...
__boundcheck_metadata_store((void *)(&f),(void *)((size_t)(&f)+sizeof(f)*8-1));
	...
	if (!(pname = av[__boundcheck_ptr_cast_to_array_reference(78,19,"main",(void *)(av),(void *)(av+0),0)])) pname = __tmp_string_0;

	ac--;
	av++;

	if (!ac) process(stdin, "*stdin*");
	else for (; *(char **)(__boundcheck_ptr_reference(84,15,"main",(void *)(av),(void *)(av))); av++) {
		if (!(f = fopen(*(char **)(__boundcheck_ptr_reference(85,20,"main",(void *)(av),(void *)(av))), "r"))) perror(*(char **)(__boundcheck_ptr_reference(85,39,"main",(void *)(av),(void *)(av))));
		else {
			process(f, *(char **)(__boundcheck_ptr_reference(87,16,"main",(void *)(av),(void *)(av))));
			fclose(f);
		}
	}
