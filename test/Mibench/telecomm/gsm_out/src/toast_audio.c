...
__boundcheck_metadata_store((void *)(&u),(void *)((size_t)(&u)+sizeof(u)*8-1));
	...
	*(unsigned long *)(__boundcheck_ptr_reference(53,3,"get_u32",(void *)(up),(void *)(up))) = 	    (u<<8)|(unsigned char)i;
	return 0;
}
...
unsigned long enc;
__boundcheck_metadata_store((void *)(&enc),(void *)((size_t)(&enc)+sizeof(enc)*8-1));
	/* unsigned 32 bits	*/
