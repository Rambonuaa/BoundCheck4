...
__boundcheck_metadata_store((void *)(&j),(void *)((size_t)(&j)+sizeof(j)*8-1));
      ...
      for (i = 0; i < j; i++)
            *(char *)(__boundcheck_ptr_reference(37,14,"bitstring",(void *)(str),(void *)(str++))) = ' ';
      while (--biz >= 0)
      {
            *(char *)(__boundcheck_ptr_reference(40,14,"bitstring",(void *)(str),(void *)(str++))) = ((byze >> biz) & 1) + '0';
            if (!(biz % 4) && biz)
                  *(char *)(__boundcheck_ptr_reference(42,20,"bitstring",(void *)(str),(void *)(str++))) = ' ';
      }
      *(char *)(__boundcheck_ptr_reference(44,8,"bitstring",(void *)(str),(void *)(str))) = '\0';
}
