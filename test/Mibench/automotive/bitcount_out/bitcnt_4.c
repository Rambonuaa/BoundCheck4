...
{
      int cnt = bits[_RV_insert_check(0,256,40,22,"ntbl_bitcnt",(int)(x & 0x0000000FL))];
__boundcheck_metadata_store((void *)(&cnt),(void *)((size_t)(&cnt)+sizeof(cnt)*8-1));
...
{
      int cnt = bits[ _RV_insert_check(0,256,54,23,"btbl_bitcnt",((char *)&x)[0] & 0xFF )];
__boundcheck_metadata_store((void *)(&cnt),(void *)((size_t)(&cnt)+sizeof(cnt)*8-1));
