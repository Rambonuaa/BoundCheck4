...
__boundcheck_metadata_store((void *)(&rowgroups_avail),(void *)((size_t)(&rowgroups_avail)+sizeof(rowgroups_avail)*8-1));


  /* Read input data if we haven't filled the main buffer yet */
  if (! main->buffer_full) {
    if (! (*(int (*)(j_decompress_ptr, JSAMPIMAGE))(__boundcheck_ptr_reference(354,26,"process_data_simple_main",(void *)(cinfo->coef->decompress_data),(void *)cinfo->coef->decompress_data))) (cinfo, main->buffer))
  ...
  (*(void (*)(j_decompress_ptr, JSAMPIMAGE, JDIMENSION *, JDIMENSION, JSAMPARRAY, JDIMENSION *, JDIMENSION))(__boundcheck_ptr_reference(367,18,"process_data_simple_main",(void *)(cinfo->post->post_process_data),(void *)cinfo->post->post_process_data))) (cinfo, main->buffer,
...
__boundcheck_metadata_store((void *)(&main),(void *)((size_t)(&main)+sizeof(main)*8-1));
  ...
  /* Read input data if we haven't filled the main buffer yet */
  if (! main->buffer_full) {
    if (! (*(int (*)(j_decompress_ptr, JSAMPIMAGE))(__boundcheck_ptr_reference(393,26,"process_data_context_main",(void *)(cinfo->coef->decompress_data),(void *)cinfo->coef->decompress_data))) (cinfo,
					   main->xbuffer[_RV_insert_check(0,2,394,9,"process_data_context_main",main->whichptr)]))
      return;			/* suspension forced, can do nothing more */
    main->buffer_full = TRUE;	/* OK, we have an iMCU row to work with */
  ...
  case CTX_POSTPONED_ROW:
    ...
    (*(void (*)(j_decompress_ptr, JSAMPIMAGE, JDIMENSION *, JDIMENSION, JSAMPARRAY, JDIMENSION *, JDIMENSION))(__boundcheck_ptr_reference(408,20,"process_data_context_main",(void *)(cinfo->post->post_process_data),(void *)cinfo->post->post_process_data))) (cinfo, main->xbuffer[_RV_insert_check(0,2,408,47,"process_data_context_main",main->whichptr)],
			&main->rowgroup_ctr, main->rowgroups_avail,
			output_buf, out_row_ctr, out_rows_avail);
    if (main->rowgroup_ctr < main->rowgroups_avail)
      return;			/* Need to suspend */
    main->context_state = CTX_PREPARE_FOR_IMCU;
    if (*(JDIMENSION *)(__boundcheck_ptr_reference(414,10,"process_data_context_main",(void *)(out_row_ctr),(void *)(out_row_ctr))) >= out_rows_avail)
  ...
  case CTX_PROCESS_IMCU:
    ...
    (*(void (*)(j_decompress_ptr, JSAMPIMAGE, JDIMENSION *, JDIMENSION, JSAMPARRAY, JDIMENSION *, JDIMENSION))(__boundcheck_ptr_reference(430,20,"process_data_context_main",(void *)(cinfo->post->post_process_data),(void *)cinfo->post->post_process_data))) (cinfo, main->xbuffer[_RV_insert_check(0,2,430,47,"process_data_context_main",main->whichptr)],
			&main->rowgroup_ctr, main->rowgroups_avail,
			output_buf, out_row_ctr, out_rows_avail);
    if (main->rowgroup_ctr < main->rowgroups_avail)
      return;			/* Need to suspend */
...
process_data_crank_post (j_decompress_ptr cinfo,
			 ...
			 JDIMENSION out_rows_avail)
{
  (*(void (*)(j_decompress_ptr, JSAMPIMAGE, JDIMENSION *, JDIMENSION, JSAMPARRAY, JDIMENSION *, JDIMENSION))(__boundcheck_ptr_reference(463,18,"process_data_crank_post",(void *)(cinfo->post->post_process_data),(void *)cinfo->post->post_process_data))) (cinfo, (JSAMPIMAGE) NULL,
