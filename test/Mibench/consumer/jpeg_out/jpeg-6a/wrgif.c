...
/* flush any accumulated data */
{
  if (dinfo->bytesinpkt > 0) {	/* never write zero-length packet */
    dinfo->packetbuf[_RV_insert_check(0,256,124,5,"flush_packet",0)] = (char) dinfo->bytesinpkt++;
...
{
  int BitsPerPixel;
__boundcheck_metadata_store((void *)(&BitsPerPixel),(void *)((size_t)(&BitsPerPixel)+sizeof(BitsPerPixel)*8-1));
int  ColorMapSize;
__boundcheck_metadata_store((void *)(&ColorMapSize),(void *)((size_t)(&ColorMapSize)+sizeof(ColorMapSize)*8-1));
int  InitCodeSize;
__boundcheck_metadata_store((void *)(&InitCodeSize),(void *)((size_t)(&InitCodeSize)+sizeof(InitCodeSize)*8-1));
int  FlagByte;
__boundcheck_metadata_store((void *)(&FlagByte),(void *)((size_t)(&FlagByte)+sizeof(FlagByte)*8-1));

  int cshift = dinfo->cinfo->data_precision - 8;
__boundcheck_metadata_store((void *)(&cshift),(void *)((size_t)(&cshift)+sizeof(cshift)*8-1));
...
__boundcheck_metadata_store((void *)(&dest),(void *)((size_t)(&dest)+sizeof(dest)*8-1));
  ...
  dest = (gif_dest_ptr)
      (*(void *(*)(j_common_ptr, int, size_t))(__boundcheck_ptr_reference(464,21,"jinit_write_gif",(void *)(cinfo->mem->alloc_small),(void *)cinfo->mem->alloc_small))) ((j_common_ptr) cinfo, JPOOL_IMAGE,
  ...
  dest->pub.buffer = (*(JSAMPARRAY (*)(j_common_ptr, int, JDIMENSION, JDIMENSION))(__boundcheck_ptr_reference(490,36,"jinit_write_gif",(void *)(cinfo->mem->alloc_sarray),(void *)cinfo->mem->alloc_sarray)))
    ((j_common_ptr) cinfo, JPOOL_IMAGE, cinfo->output_width, (JDIMENSION) 1);
  dest->pub.buffer_height = 1;

  /* Allocate space for hash table */
  dest->hash_code = (code_int *)
    (*(void *(*)(j_common_ptr, int, size_t))(__boundcheck_ptr_reference(496,19,"jinit_write_gif",(void *)(cinfo->mem->alloc_small),(void *)cinfo->mem->alloc_small))) ((j_common_ptr) cinfo, JPOOL_IMAGE,
				HSIZE * SIZEOF(code_int));
  dest->hash_value = (hash_entry FAR *)
    (*(void *(*)(j_common_ptr, int, size_t))(__boundcheck_ptr_reference(499,19,"jinit_write_gif",(void *)(cinfo->mem->alloc_large),(void *)cinfo->mem->alloc_large))) ((j_common_ptr) cinfo, JPOOL_IMAGE,
