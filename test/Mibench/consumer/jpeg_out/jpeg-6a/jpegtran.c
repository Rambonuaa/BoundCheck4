...
__boundcheck_metadata_store((void *)(&scansarg),(void *)((size_t)(&scansarg)+sizeof(scansarg)*8-1));
  ...
  for (argn = 1; argn < argc; argn++) {
    arg = argv[argn];
    if (*(char *)(__boundcheck_ptr_reference(100,10,"parse_switches",(void *)(arg),(void *)(arg))) != '-') {
...
__boundcheck_metadata_store((void *)(&srcinfo),(void *)((size_t)(&srcinfo)+sizeof(srcinfo)*8-1));

  struct jpeg_compress_struct dstinfo;
__boundcheck_metadata_store((void *)(&dstinfo),(void *)((size_t)(&dstinfo)+sizeof(dstinfo)*8-1));

  struct jpeg_error_mgr jsrcerr;
__boundcheck_metadata_store((void *)(&jsrcerr),(void *)((size_t)(&jsrcerr)+sizeof(jsrcerr)*8-1));
struct jpeg_error_mgr  jdsterr;
__boundcheck_metadata_store((void *)(&jdsterr),(void *)((size_t)(&jdsterr)+sizeof(jdsterr)*8-1));

#ifdef PROGRESS_REPORT
  struct cdjpeg_progress_mgr progress;
#endif
  jvirt_barray_ptr * coef_arrays;
__boundcheck_metadata_store((void *)(&coef_arrays),(void *)((size_t)(&coef_arrays)+sizeof(coef_arrays)*8-1));
...
__boundcheck_metadata_store((void *)(&output_file),(void *)((size_t)(&output_file)+sizeof(output_file)*8-1));
  ...
  progname = argv[0];
  if (progname == NULL || (*(const char *)(__boundcheck_ptr_reference(253,27,"main",(void *)(&progname[0]),(void *)(&progname[0])))) == 0)
