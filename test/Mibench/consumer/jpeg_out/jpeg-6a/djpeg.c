...
__boundcheck_metadata_store((void *)(&arg),(void *)((size_t)(&arg)+sizeof(arg)*8-1));
  ...
  for (argn = 1; argn < argc; argn++) {
    arg = argv[argn];
    if (*(char *)(__boundcheck_ptr_reference(185,10,"parse_switches",(void *)(arg),(void *)(arg))) != '-') {
...
__boundcheck_metadata_store((void *)(&printed_version),(void *)((size_t)(&printed_version)+sizeof(printed_version)*8-1));
	...
	FILE * mapfile;
__boundcheck_metadata_store((void *)(&mapfile),(void *)((size_t)(&mapfile)+sizeof(mapfile)*8-1));
...
__boundcheck_metadata_store((void *)(&datasrc),(void *)((size_t)(&datasrc)+sizeof(datasrc)*8-1));
  ...
  if (datasrc->bytes_in_buffer == 0) {
    if (! (*(boolean (*)(j_decompress_ptr))(__boundcheck_ptr_reference(360,22,"jpeg_getc",(void *)(datasrc->fill_input_buffer),(void *)datasrc->fill_input_buffer))) (cinfo))
...
__boundcheck_metadata_store((void *)(&traceit),(void *)((size_t)(&traceit)+sizeof(traceit)*8-1));
...
__boundcheck_metadata_store((void *)(&requested_fmt),(void *)((size_t)(&requested_fmt)+sizeof(requested_fmt)*8-1));
...
__boundcheck_metadata_store((void *)(&dest_mgr),(void *)((size_t)(&dest_mgr)+sizeof(dest_mgr)*8-1));
...
__boundcheck_metadata_store((void *)(&num_scanlines),(void *)((size_t)(&num_scanlines)+sizeof(num_scanlines)*8-1));
  ...
  progname = argv[0];
  if (progname == NULL || (*(const char *)(__boundcheck_ptr_reference(438,27,"main",(void *)(&progname[0]),(void *)(&progname[0])))) == 0)
  ...
  (*(void (*)(j_decompress_ptr, djpeg_dest_ptr))(__boundcheck_ptr_reference(567,15,"main",(void *)(dest_mgr->start_output),(void *)dest_mgr->start_output))) (&cinfo, dest_mgr);

  /* Process data */
  while (cinfo.output_scanline < cinfo.output_height) {
    num_scanlines = jpeg_read_scanlines(&cinfo, dest_mgr->buffer,
					dest_mgr->buffer_height);
    (*(void (*)(j_decompress_ptr, djpeg_dest_ptr, JDIMENSION))(__boundcheck_ptr_reference(573,17,"main",(void *)(dest_mgr->put_pixel_rows),(void *)dest_mgr->put_pixel_rows))) (&cinfo, dest_mgr, num_scanlines);
  }
   ...
   */
  (*(void (*)(j_decompress_ptr, djpeg_dest_ptr))(__boundcheck_ptr_reference(587,15,"main",(void *)(dest_mgr->finish_output),(void *)dest_mgr->finish_output))) (&cinfo, dest_mgr);
