...
keymatch (char * arg, const char * keyword, int minchars)
{
  ...
  while ((ca = *(char *)(__boundcheck_ptr_reference(125,20,"keymatch",(void *)(arg),(void *)(arg++)))) != '\0') {
    if ((ck = *(const char *)(__boundcheck_ptr_reference(126,23,"keymatch",(void *)(keyword),(void *)(keyword++)))) == '\0')
