...
int main(void)
{
  ...
  bob1 = (data *)__e_acsl_malloc(sizeof(data));
  ...
  strcpy(bob1->name[1],__e_acsl_literal_string);
  /*@ assert rte: mem_access: \valid_read(&bob1->name[1][2]); */
  {
    int __e_acsl_valid_read;
    __e_acsl_valid_read = __valid_read((void *)(& bob1->name[0][2]),
                                       sizeof(char));
    e_acsl_assert(__e_acsl_valid_read,(char *)"Assertion",(char *)"main",
                  (char *)"rte: mem_access: \\valid_read(&bob1->name[1][2])",
                  23);
  }
  ...
  printf(__e_acsl_literal_string_2,bob1->name[1][2]);
  __retres = 0;
